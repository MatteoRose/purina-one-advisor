    ...
    <div className="relative min-h-screen">
      ...
      <div className="relative max-w-3xl mx-auto px-4 sm:px-6 py-6 sm:py-8 print:bg-white print:text-black">
        ...
        >
          ...
          {/* ─── Print-only KIN ADVISOR signature ───
                Appears ONLY in the printed PDF (the screen outro above is
                hidden via `no-print`). Paper-friendly design: no
                gradients, no glow, no animation — minimal ink, legible
                in both color and B&W output. Sealed at the bottom of
                the printed plan so any recipient sees that the document
                was generated by KIN Advisor. */}
          <div className="hidden print:block mt-10 pt-6 border-t border-black text-center text-black">
            <p className="text-[9px] font-bold tracking-[0.32em] text-black/70 mb-1">
              PURINA&nbsp;&nbsp;ONE
            </p>
            <p className="text-purina-red font-black text-2xl tracking-tight leading-none">
              KIN&nbsp;ADVISOR
            </p>
            <p className="italic text-sm mt-3 text-black/85">
              Guided by Nutrition. Led by Purina.
            </p>
            <div className="h-[1px] w-12 bg-purina-red mx-auto my-3" />
            <p className="text-[9px] text-black/55 tracking-wider">
              Personalized plan generated by KIN Advisor &middot; kin.purina.it
            </p>
          </div>
        </motion.div>
      </div>
